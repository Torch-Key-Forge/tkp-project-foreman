...
document.getElementById("recoverBtn").addEventListener("click", async () => {
  ...
  statusEl.textContent = "Recovering project spine, authority, continuation state, and source traces…";
  ...
  statusEl.textContent = "Recovery complete. Every recovered claim remains linked to source evidence.";
});
...
document.getElementById("exportBtn").addEventListener("click", async () => {
  ...
  try {
    ...
    out.textContent = `Validated export: ${result.filename} · 8 files · Downloads\\Project_Foreman_Exports`;
  } catch (error) {
